...
[MAIN] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_MUTE,KC_N,    KC_M, KC_COMM,  CS_00, TD(TD_HARD_ZNAK), KC_SLSH,
                 KC_LSFT,KC_LALT,KC_LCTL, TL_LOWR, KC_ENT,      KC_SPC,  TL_UPPR, KC_F13, KC_RALT, KC_RSFT
),
/* NUMPAD
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | trans|      |      |      |      |      |                    |      |NumLck|      |      |      |      |
...
[_NUMPAD] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_CIRC, KC_P7,  KC_P8,   KC_P9,   XXXXXXX, XXXXXXX,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_MINS, KC_P4,  KC_P5,   KC_P6,   XXXXXXX,  XXXXXXX,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,_______,   _______,KC_P0, KC_P1,  KC_P2,   KC_P3,   XXXXXXX, XXXXXXX,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
              _______, XXXXXXX, _______, _______, _______,   _______, MO(HIGH), KC_P0 ,   KC_PDOT, _______
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[LOW] = LAYOUT(
  ...
  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, TG(_NUMPAD), _______,       _______, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, _______,
...
[HIGH] = LAYOUT(
  ...
  _AMPR,  _ASTR,  _AT,   _HASH,  _DLR, _CIRC,                        KC_PGUP, _PIPE,   KC_UP, _LBRC,_RBRC, KC_RBRC,
  _SCLN, _DQUO,  _QUOT,  _QUES,_EXLM  , _COLN,                       KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_DEL, KC_BSPC,
  KC_EQL, _PERC,S(KC_MINS), KC_MINS, _LPRN, _RPRN,  _______,       _BSLS,  QK_LEAD, _SLSH, XXXXXXX, _______,   XXXXXXX, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* ADJUST
 * ,----------------------------------------.                    ,-----------------------------------------.
 ...
 */
[ADJUST] = LAYOUT(
  XXXXXXX, XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , KC_SLEP,                           XXXXXXX,  XXXXXXX  , XXXXXXX,  XXXXXXX ,  XXXXXXX ,XXXXXXX,
